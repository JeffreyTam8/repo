   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	 ...
	 int i = 0;
     int minimumArr = intArray[0][column];
     for(i = 0; i < intArray.length; i++) {
    	 if(intArray[i][column] < minimumArr) {
    		 minimumArr = intArray[i][column];
    	 }
    	 
    	 animate(i, column, minimumArr);
     }
	   return minimumArr;
   }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   for(int i = 0; i < intArray.length; i++) {
		   for(int j = 0; j < intArray[i].length; j++) {
			   if(value == intArray[i][j]) {
				   counter++;
			   }
			   animate(i, j, value);
		   }
	   }
     return counter; // replace this line with your return statement
   }
